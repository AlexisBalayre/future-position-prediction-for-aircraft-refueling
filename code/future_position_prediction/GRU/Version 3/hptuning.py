...
if __name__ == "__main__":
    ...
    data_module = LSTMLightningDataModule(
        data_folder="/Users/alexis/Library/CloudStorage/OneDrive-Balayre&Co/Cranfield/Thesis/thesis-github-repository/data/frames/full_dataset_annotated_fpp/processed_data",
        ...
        for encoder_layer_nb in encoder_layer_nbs:
                for scheduler_patience in scheduler_patiences:
                    for scheduler_factor in scheduler_factors:
                            ...
                            results.to_csv("gru_version3_2.csv", index=False)