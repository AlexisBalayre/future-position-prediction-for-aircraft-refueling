...
if __name__ == "__main__":
    ...
    checkpoint_path = "/Users/alexis/Library/CloudStorage/OneDrive-Balayre&Co/Cranfield/Thesis/thesis-github-repository/code/future_position_prediction/GRU/SizPos/logs/concat/version_30/checkpoints/epoch=141-step=53108.ckpt"
                    ...
                    for scheduler_patience in scheduler_patiences:
                        for scheduler_factor in scheduler_factors:
                            ...
                            test_metrics = trainer.test(
                                model, datamodule=data_module, ckpt_path=checkpoint_path
                            )[0]
