...
class SizPosGRULightningModelSum(L.LightningModule):
    """
    Main PyTorch Lightning module of the SizPos-GRU model that predicts future bounding box 
    positions and sizes by summing the hidden states from position and size encoders.
    ...
    def __init__(
        ...
        super(SizPosGRULightningModelSum, self).__init__()
    ...
    def forward(
        ...
        # Combine the hidden states and cell states (sum)
        h_pos = h_size = encoder_hidden_states_pos + encoder_hidden_states_size
