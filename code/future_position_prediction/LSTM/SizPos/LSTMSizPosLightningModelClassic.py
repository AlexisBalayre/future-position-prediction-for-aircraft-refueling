...
class LSTMSizPosLightningModelClassic(L.LightningModule):
    """
    Main PyTorch Lightning module of the SizPos-LSTM model that predicts future bounding box 
    positions and sizes using separate encoders and decoders for position and size data.
    ...
    def __init__(
        ...
        super(LSTMSizPosLightningModelClassic, self).__init__()
